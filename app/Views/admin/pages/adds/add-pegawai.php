...
<form method="POST" action="<?= route_to('save_pegawai'); ?>" class="needs-validation" novalidate="" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control <?= ($valid->hasError('nama_pegawai')) ? 'is-invalid' : ''; ?>" name="nama_pegawai" value="<?= old('nama_pegawai'); ?>" placeholder="Input Nama Pegawai">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control <?= ($valid->hasError('username')) ? 'is-invalid' : ''; ?>" name="username" value="<?= old('username'); ?>" placeholder="Input Username">
            <div class="invalid-feedback">
