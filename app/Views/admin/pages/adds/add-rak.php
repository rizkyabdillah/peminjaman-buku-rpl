...
<form method="POST" action="<?= route_to('save_kategori'); ?>" class="needs-validation" novalidate="" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control <?= ($valid->hasError('nama_kategori')) ? 'is-invalid' : ''; ?>" name="nama_kategori" value="<?= old('nama_kategori'); ?>" placeholder="Input kategori">
