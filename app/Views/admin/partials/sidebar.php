<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?= ($sidebar == 3) ? 'active' : ''; ?>"><a class="nav-link" href="<?= route_to('view_kategori_buku'); ?>"><i class="fas fa-book-open"></i> <span>Data Kategori Buku</span></a></li>
            <li class="<?= ($sidebar == 4) ? 'active' : ''; ?>"><a class="nav-link" href="<?= route_to('view_rak_buku'); ?>"><i class="fas fa-bookmark"></i> <span>Data Rak Buku</span></a></li>
